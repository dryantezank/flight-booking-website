...
<head>
    ...
    <title>AGU AIRWAY ADMIN DASHBOARD</title>
</head>
...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <a class="navbar-brand" href="index.html">AIRWAY ADMIN</a>
    ...
    <div class="nav-left-sidebar sidebar-dark">
        <div class="menu-list">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="d-xl-none d-lg-none" href="#">Trang thống kê</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"></i>Trang thống kê <span class="badge badge-success">6</span></a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2">Khách hàng</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3">Danh sách chuyến bay</a>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4">Danh sách đặt vé</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5">Danh sách địa điểm</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-6" aria-controls="submenu-6"> Đánh giá khiếu nại </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7">Tư vấn <span class="badge badge-secondary">New</span></a>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Trang Thống Kê</h2>
                            <p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Trang Chủ</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Trang thống kê</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="ecommerce-widget">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-muted">Tổng cộng thanh toán</h5>
                                    <div class="metric-value d-inline-block">
                                        <h1 class="mb-1">$1205</h1>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-muted">Tổng lượt đặt vé</h5>
                                    <div class="metric-value d-inline-block">
                                        <h1 class="mb-1">24</h1>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-muted">Lượt hủy vé</h5>
                                    <div class="metric-value d-inline-block">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-muted">Thanh toán trung bình mỗi user</h5>
                                    <div class="metric-value d-inline-block">
                                        <h1 class="mb-1">$50.208</h1>
                                    </div>
                                    <div class="metric-label d-inline-block float-right text-secondary font-weight-bold">
                                        <span>-2.00%</span>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Danh sách đặt vé</h5>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0">Ngày đi</th>
                                                <th class="border-0">Điểm khởi hành</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>(ĐN) Đà Nẵng </td>
                                                <td><span class="badge-dot badge-brand mr-1"></span>Chờ duyệt </td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>User_2 </td>
                                                ...
                                                <td>(HCM) Hồ Chí Minh</td>
                                                <td><span class="badge-dot badge-success mr-1"></span>Đã duyệt </td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>User_3 </td>
                                                ...
                                                <td>(CT) Cần Thơ </td>
                                                <td><span class="badge-dot badge-danger mr-1"></span>Đã hủy </td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td>User_4 </td>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Thống Kê Khách Hàng</h5>
                                <div class="card-body">
